...
songplay_table_create =(""" CREATE TABLE IF NOT EXISTS songplay( songplay_id integer NOT NULL IDENTITY(0,1), start_time TIME, user_id TEXT, level TEXT, song_id TEXT , artist_id TEXT, session_id TEXT , location TEXT , user_agent TEXT )
...
song_table_create = ("""CREATE TABLE IF NOT EXISTS song( song_id text PRIMARY key NOT NULL , title text , artist_id text, YEAR INTEGER , duration text )sortkey(song_id, artist_id)""")

artist_table_create = ("""CREATE TABLE IF NOT EXISTS artist ( artist_id text PRIMARY key  NOT NULL , name text, location text , lattitude text, longitude text )sortkey(artist_id, name) """)

time_table_create = ("""CREATE TABLE IF NOT EXISTS TIME ( start_time text PRIMARY key NOT NULL  , HOUR text , DAY text , week text , MONTH text, YEAR INTEGER , weekday text )sortkey(start_time, weekday) """)
